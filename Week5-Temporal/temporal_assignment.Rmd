...
1. Calculate stability (i.e., 1/CV) and synchrony for each plot type.
...
## When we say "Calculate stability (i.e., 1/CV) and synchrony for each plot type.", it's not entirely clear what biological variable we are suggesting they work with, presumably total abundance

## I'm a litle confused by wording of question 8a. "How is stability measured with this function? How does this relate to the coefficient of variation?" Maybe I'm overthinking it. 
