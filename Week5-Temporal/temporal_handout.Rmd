...
In this hadnout, we will explore some basic aspects of temporal diversity. 
...
package.list <- c('vegan', 'tidyr', 'dplyr', 'codyn', 'ggplot2', 'cowplot', 'MullerPlot', 'RColorBrewer', 'reshape2', 'lubridate', 'TTR', 'xtable', 'multcomp', 'pander', 'png', 'grid')
...
abund <- filter(time.by.spec.2, plot_id == 2) %>% group_by(year, season) %>% count(wt = n)
