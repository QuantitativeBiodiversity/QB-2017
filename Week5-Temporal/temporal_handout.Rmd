...
As we have learned this semester, \beta-diversity examines the diversity between samples.
In previous weeks, we have emphasized features of \beta-diversity with regard to the distributions of samples in space.
...
Immigration, competitive exlusion, diseases, invasion, etc.
...
Next, to facilitate plotting, we can turned the wide form data table back into a long form. 
...
The keys in the metric column will be (are) the old columns we are gathering together (total, appearance, disappearance).
