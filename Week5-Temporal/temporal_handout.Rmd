...
richness<-rowSums(time.by.species[,-c(1,3)])
rich.filt <- as.data.frame(time.by.species[,1:3,], richness)
rich.filt2 <- rich.filt[which(rich.filt$plot_type == "Control" | rich.filt$plot_type == "Rodent Exclosure"), ]
```
