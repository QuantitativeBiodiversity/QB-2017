...
Biological diversity ~~systems are inherently variable~~ varies through time in response to changes in the biotic and abiotic environment. 
...
While some biologists focus on processes that occur on contemporary scales (minutes, days, weeks, years), other scientists are interested in ~~what~~ the forces that drive patterns of biodiversity in the fossil record and over geologic time scales.
In this handout, we will first introduce you to a new ecological data structure, the ~~time-by-site-species~~ time-by-site-by-species matrix **(1. its a mouthful, 2. you could just say that we'll be adding a temporal dimension to the site-by-species matrix...something the students already know about).**
You will be introduced to R data handling packages that will help you ~learn how to~ manage and manipulate this ~~type of~~ data structure. ~~using some new R packages.~~ 
You will then learn ~~introduce~~ the basics of time series analysis, ~~which will be followed by sections dealing with~~ repeated-measures analysis of variance ~~(RM-ANOVA)~~, temporal beta diversity (i.e., turnover), and synchrony (do you simply mean temporal covariation?). Whatever happened to stability, resistence, etc.?
...
**You've told them about the function below. Why not tell them what these packages are? HELP THEM FEEL MORE CONNECTED TO WHAT IS GOING ON.**
...
To learn about topics of temporal ~bio~diversity, we will use the long-term rodent dataset from the Chihuahuan Desert ecosystem near Portal, Arizona.
Known as the "Portal Project" <http://portal.weecology.org/>, this ~~biodiversity study~~ research site was initiated in 1977 ~~the late 1970s~~ by Jim Brown and colleagues to study ~~look at~~ species interactions, specifically competitive dynamics within and among species of rodents and ants.

~~Early experiments focused on the exclusion of rodents with fencing and trapping, which led to an increase in the ant population size as well as changes in plant species composition.~~ **<- deleted because 1. they also excluded ants via poisoning, 2. the "early" experiments were not conducted at the portal site.**

These findings inspired Brown and colleagues to construct an improved experiment that continues today. **<-- Again, the early studies were not conducted at the Portal site.**

Once every month since 1977, members of The Portal Project monitors 24 replicated experimental plots, each 0.25 ha in area (50 X 50 m).
...
2) Long-term Krat - long-term exclusion of Kangaroo rats (*Dipodomys spp.* ~~merriami*~~) (plot_id: 3, 15, 19, 21) 

3) Short-term Krat - short-term exclusion of Kangaroo rats (*Dipodomys spp.* ~~merriami*~~)  (plot_id: 6, 13, 18, 20) 
...
~~In addition to generating a lot of quality information, it was critical for the Portal Project's data to be organized, accessible, and properly managed.~~  **<-- These statements don't add valuable context, as is. They should be revised or deleted.**

**Probably a better jumping off point -->**  One thing you may notice when looking at `portal` is that it has a lot of observations, almost 35,000 (and remember this is only 1977 - 2002).
...
# p-value = 0.3252 for this, which would indicate stationarity, correct?
```
