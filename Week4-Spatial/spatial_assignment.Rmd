...
***Question 2a***:  How many sites and OTU's are in the SiteBySpecies matrix? 
...
***Question 6***: In your own words, explain distance decay pattern and what it reveals.

> ***Answer 6***:

In the R code chunk below, do the following:  

1. Generate the distance decay relationship for bacterial communities of our refuge ponds and for some of the environmental variables we measured. 
...
***Question 7***: What can you conclude about community similarity in regards to environmental distance and geographic distance?
...
2. Draw 6 OTUs at random from the IN ponds dataset and and plot their SSADs as kernel density curves. Use **while loops**  and **if** statements to accomplish this.
...
# 4. Write a 'while' loop to plot the SSADs of 6 species chosen at random 
...
1. Using the handout for assistance, use a nested design to examine the SAR of our simulated community.
2. Plot the SAR and regression line. Consult the handout for assistance.
...
## SYNTHESIS
Load the dataset you are using for your project. Plot and discuss either the geogrpahic Distance-Decay relationship, the SSADs for at least 4 species, or any variant of the SAR (e.g., random accumulation of plots or areas, accumulation of contiguous plots or areas, nested design).