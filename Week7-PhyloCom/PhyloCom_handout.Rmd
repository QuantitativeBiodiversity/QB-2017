...
You learned that factors such as these can lead to spatial autocorrelation in patterns of diversity, i.e., the tendency for near things to be more similar than distant things.
...
legend("topleft", legend= c(paste("Spearman Correlation = ", rho, "; p = ", rho.pval, sep = ""),
                            paste("Pearson Correlation = ", P, "; p = ", P.val, sep = "")),
                            bty = "n", col = "red") 
```
