...
Another important assumption that many of these analyses make is that species show niche conservatism, that is, their niches remain relatively fixed through time (Wiens and Graham 2005, Wiens et al. 2010). 
The assumption of niche conservatism allows us to posit that ....
If niches are not conserved, species may 
If niches are not conserved over time, 