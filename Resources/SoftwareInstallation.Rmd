...
**Mac users please read**:
    ...
    You can download XQuartz v2.7.11 from the following site:https://www.xquartz.org/
    
## Git

We will be using Git as the version control software to manage our text and code.
If you do not have a current Git installation (v2.10.2 or later), please do the following:
...
If you do not have a current RStudio version installed on your computer (v 1.0.1 +), please do the following:
