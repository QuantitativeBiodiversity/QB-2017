...
We *stronly* recommend that you configure this behavior in order to prevent any future issues when collaborating across computer platforms.
...
1. Navigate to and click on your student repository (repo) on https://github.com/QuantitativeBiodiversity/QB-2017
...
(In the example bleow, you will need to replace "Repo" with the nambe of your QB Repository)

    ```sh
    git remote -v
    git remote add upstream https://github.iu.edu/2017-QuantitativeBiodiversity/Repo
    git remote -v
    ```
...
We check for these cahnges using the git commands **fetch** and **merge** as follows:
...
In addition to pulling youe upstream repo, you always want to push any updates to your origin.
