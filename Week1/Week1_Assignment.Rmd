...
Space for your answers are provided in this document and is indicated by the ">" character.
...
The completed exercise is due on **Wednesday, January 18^st^, 2017 before 12:00 PM (noon)**.
...
Even if you are able to knit without issue, it is good practice to review the PDF before you submit the assignment.
...
To follow up on the Week 0 exercises, please peform the requested operations in the Rcode chunks below.
Feel free to reference the Week 0 handout. 
...
Create a site-by-species matrix (or dataframe) that does not include TANK oor NUTS.
...
***Question 9***: With the visualization and statistical tools that we leanred about in the Week 1 Handout, use the site-by-species matrix to assess whether and how different zooplankton taxa were responsible for the total biomass (ZP) resppone to nutrient enrichment. Describe what you learnd below in the "Answer" section and include appropriate code in the R chunk.
...
This assignment is due on **Wednesday, January 18^th^, 2015 at 12:00 PM (noon)**.
