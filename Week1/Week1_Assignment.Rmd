...
In the R code chunk below, calculate the **summary statistics** (ie., maximum, minimum, sum, mean, median, variance, standard deviation, and standard error of the mean) for the vector (`v`) provided.
