...
There are a few places you might look for biodiveristy data sets, including ESA data papers (<https://goo.gl/Ag7rr8>), the LTER data portal (<https://portal.lternet.edu/nis/home.jsp>), or the Dryad digital respository (<http://datadryad.org/>). 

There are a few things that you will want to look for in a useful dataset for the QB Group Diversity Projects:

1) Need a site-by-species matrix (see end of Week 1 handout), which contains presence-absence or species abudndance data for multiple sites or locations.

2) In week 3 we will discuss beta-diversity and how to use enviromental data to explain patterns of community composiiton. Therefore, it would be useful if you site-by-species matrix was accompanied by a site-by-enviroment matrix.
...
You will become familiar with your dataset becasue we will be asking you questions about it from week to week as part of course assignments. 
...
The slides to your powepoint presnetation should be pushed to Github by **noon on Saturday, February 24, 2017**
