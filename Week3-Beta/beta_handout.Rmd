...
a.  What are the key differences between incidence- and abundance-based metrics?
...
***Question 6***: Based on cluster analyses and the introdutory plots that we generated after loading the data, develop a hypothesis about the distribution of fish assemblages in the Doubs River? 
...
While Whittaker (1960, 1972) advocated a multiplicative approach, others have suggested addititive partitioning: $\gamma = \alpha + \beta$ (see Lande (1996) and Veech et al. (2002) for reviews). 
Addititive partitioning changes the interpretation of $\beta$ from a measure of *how many times* more diverse the region is than local sites, to a measure of *how many more species* exist in the regional pool than in local sites. 
