...
Instead, we will work with Git using the **shell**, a command-line way to access your operating system's services.
...
+ Navitate to <https://github.com/> and click on the "sign up" icon
...
+ An open-access copy of the paper can be found on line, but is also posted on the course Canvas site. 
...
Assignments in this class will require that you successfully create a Markdown-generated PDF using knitr; you will then **push** this document to the course **respository** hosted on GitHub (<https://github.com/QuantitativeBiodiversity/QB-2017>) and generate a **pull request**.
...
But for now, we are going to become familiar with a web-based version of RStudio that does not require an installations. 
...
The same procedure can be performed at the **command line** in the Rstudio console pane or **script editor pane** (upper righ).
...
Agai, use the **console pane** in the lower left to complete the following exercises:
