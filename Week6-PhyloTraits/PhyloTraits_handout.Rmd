...
We will rely heavily on the `ape` (http://goo.gl/nExs0), which performs a wide range of phylogenetic analyses. 
...
We set out to test this hypothesized trade-off in aquatic bacteria by assessing generalist and specialist strategies on different forms of phosphorus, a resource which commonly limits growth and reproduction of organisms inhabiting freshwater ecosystems.
...
After generating or retrieving sequence data, the first step of a phylogenetic analysis is to perform an alignment. 
