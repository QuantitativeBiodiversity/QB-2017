...
b. Using the saturation plot and cophylogenetic plots from above, describe the effect that the substitution model you chose has on your phylogenetic reconstruction. 
If the plots seem to be inconsistent with one another, explain what it giving rise to the differences.
c. How does the effect of your model compare to the *F84* model? What does this tell you about the substitution rates of nucleotide transitions?
...
Below is the output of a multiple regression model depicting the relationship between the maximum growth rate ($\mu_{max}$) of each bacterial isolate and the niche breadth of that isoalte on the 18 different sources of phosphorus. 
