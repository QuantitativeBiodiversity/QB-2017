...
S.ace <- function(x = "", thresh = 10){ 
  ...
  C.ace   <- 1 - (singlt / N.rare)      # coverage (prop non-single rare inds)
...
The difference being that an estimate of diversity implicitly or explicitly accounts for sampling error, that is, the fact that when sampling most ecological communities that we are not observing every single individual.
