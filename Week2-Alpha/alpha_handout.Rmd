...
***The above statement doesn't agree with the following code. We should probably decide on using invD or D.inv in both cases for clarity, and are we still planning to calculate 1-D?***
```{r, results='hide'}
D.inv <- 1/SimpD(site1)
```
